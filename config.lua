...
Config.Stores = {
	...
	[8] =   {shopType = "clothing", coords = vector3(-798.68, -606.71, 30.28)},
...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", coords = vector3(461.83, -996.49, 30.69), cameraLocation = vector4(461.79, -996.5, 30.69, 266.76)},
